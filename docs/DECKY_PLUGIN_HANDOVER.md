...
## 7. Multi-slot additions (DS5 Multi-Bridge fork)

The multi-controller fork adds — all **additive**, nothing existing changed:

- `GET /api/slots` — per-slot status: `{max, connected, audio_slot,
