...
// bt.h provides bt_control_cid() / bt_control_send() / bt_feature_cached(),
// all bound to the USB-exposed slot (BT_USB_SLOT) — the only controller whose
// Edge profiles are reachable over USB.
